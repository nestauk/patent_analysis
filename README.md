...
------------
    ...
    │
    ├── setup.py           <- makes project pip installable (pip install -e .) so patents can be imported
    │
    ├── patents                <- Source code for use in this project.
    │   ├── __init__.py    <- Makes patents a Python module
    │   │
